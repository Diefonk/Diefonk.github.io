function getUpdateLink(update) {
	...
	if (update.linkText) {
		...
		link += update.first + "' target='_blank'>Problem Sleuth p.";
		...
		link += update.first + "' target='_blank'>Bard Quest p.";
		if (update.first === update.last) {
			link += update.first;
		} else {
			link += update.first + "-" + update.last;
		...
		link += update.first + "' target='_blank'>Homestuck^2 p.";
		if (update.first === update.last) {
			link += update.first;
		} else {
			link += update.first + "-" + update.last;
		...
		link += update.first + "' target='_blank'>Homestuck p.";
		if (update.first === update.last) {
			link += update.first;
		} else {
			link += update.first + "-" + update.last;
